...
export const config = {
  ...
  store: {
    ...
    stripeSecretKey: first('STRIPE_SECRET_KEY'),
    stripeWebhookSecret: first('STRIPE_WEBHOOK_SECRET'),
    stripeWebhookPath: routePath(first('STRIPE_WEBHOOK_PATH'), '/stripe/webhook'),
    stripeSuccessPath: routePath(first('STRIPE_SUCCESS_PATH'), '/store/success'),
    stripeCancelPath: routePath(first('STRIPE_CANCEL_PATH'), '/store/cancel'),
