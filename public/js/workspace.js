    ...
    root().innerHTML=`<div class="calendar-nexus">
      ...
      <main class="nexus-layout">
        ...
        <section class="nexus-replay holo-panel">
          ...
          <div class="replay-rail"><span>◉ PRICE PATH</span><span>◇ ENTRY TELEMETRY</span><span>◆ EXIT TELEMETRY</span><span>✦ AI CONTEXT</span></div>
        </section>
