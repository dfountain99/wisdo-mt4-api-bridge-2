...
${result.secret}`)}catch(error){status.className='form-status error';status.textContent=error.message} };
  ...
  async function drawCalendar() {
    ...
    root().innerHTML=`<div class="mission-calendar">
      <div class="mission-space"><div class="earth"></div><div class="station-ring"></div><div class="mission-floor"></div></div>
      ...
      <main class="mission-grid">
        ...
        <div class="wisdo-core"><div class="core-rings r1"></div><div class="core-rings r2"></div><div class="core-earth"><b>W</b></div><strong>WISDO</strong><span>ANALYZE · EXECUTE · EVOLVE</span></div>
