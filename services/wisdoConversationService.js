...
export class WisdoConversationService {
  ...
  async answer(input={}){
    ...
    try{
      ...
      const text=error.code==='trading_offline'?COACH_RESPONSES.offline:error.code==='demo_only_live_blocked'||error.code==='voice_execution_disabled'?COACH_RESPONSES.demoOnly:error.code==='unsupported_action'?COACH_RESPONSES.unsupported:COACH_RESPONSES.failed;
