...
export function registerConversationalVoiceRoutes(app,{commandBusService,voiceService,mt4CommandService,mt4SyncService,copyTradingService,commandRegistryAudit=null,logger=console}={}){
  ...
  return {conversationService,intentService,contextService,safetyService,confirmationService,planService,executionService,planMonitorService,adaptiveFabricService,deviceService,educationService,audioService};
}
